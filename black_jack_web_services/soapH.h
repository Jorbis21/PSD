...
#ifndef SOAP_TYPE_blackJackns__play_DEFINED
#define SOAP_TYPE_blackJackns__play_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_blackJackns__play(struct soap*, struct blackJackns__play *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_blackJackns__play(struct soap*, const struct blackJackns__play *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_blackJackns__play(struct soap*, const char*, int, const struct blackJackns__play *, const char*);
SOAP_FMAC3 struct blackJackns__play * SOAP_FMAC4 soap_in_blackJackns__play(struct soap*, const char*, struct blackJackns__play *, const char*);

SOAP_FMAC3 struct blackJackns__play * SOAP_FMAC4 soap_new_blackJackns__play(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_blackJackns__play(struct soap*, const struct blackJackns__play *, const char*, const char*);

#ifndef soap_write_blackJackns__play
#define soap_write_blackJackns__play(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_blackJackns__play(soap, data), 0) || soap_put_blackJackns__play(soap, data, "blackJackns:play", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT_blackJackns__play
#define soap_PUT_blackJackns__play(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_blackJackns__play(soap, data), 0) || soap_put_blackJackns__play(soap, data, "blackJackns:play", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH_blackJackns__play
#define soap_PATCH_blackJackns__play(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_blackJackns__play(soap, data), 0) || soap_put_blackJackns__play(soap, data, "blackJackns:play", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send_blackJackns__play
#define soap_POST_send_blackJackns__play(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_blackJackns__play(soap, data), 0) || soap_put_blackJackns__play(soap, data, "blackJackns:play", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct blackJackns__play * SOAP_FMAC4 soap_get_blackJackns__play(struct soap*, struct blackJackns__play *, const char*, const char*);

#ifndef soap_read_blackJackns__play
#define soap_read_blackJackns__play(soap, data) ( ((data) ? (soap_default_blackJackns__play(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_blackJackns__play(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET_blackJackns__play
#define soap_GET_blackJackns__play(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read_blackJackns__play(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv_blackJackns__play
#define soap_POST_recv_blackJackns__play(soap, data) ( soap_read_blackJackns__play(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_blackJackns__playResponse_DEFINED
#define SOAP_TYPE_blackJackns__playResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_blackJackns__playResponse(struct soap*, struct blackJackns__playResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_blackJackns__playResponse(struct soap*, const struct blackJackns__playResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_blackJackns__playResponse(struct soap*, const char*, int, const struct blackJackns__playResponse *, const char*);
SOAP_FMAC3 struct blackJackns__playResponse * SOAP_FMAC4 soap_in_blackJackns__playResponse(struct soap*, const char*, struct blackJackns__playResponse *, const char*);

SOAP_FMAC3 struct blackJackns__playResponse * SOAP_FMAC4 soap_new_blackJackns__playResponse(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_blackJackns__playResponse(struct soap*, const struct blackJackns__playResponse *, const char*, const char*);

#ifndef soap_write_blackJackns__playResponse
#define soap_write_blackJackns__playResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_blackJackns__playResponse(soap, data), 0) || soap_put_blackJackns__playResponse(soap, data, "blackJackns:playResponse", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT_blackJackns__playResponse
#define soap_PUT_blackJackns__playResponse(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_blackJackns__playResponse(soap, data), 0) || soap_put_blackJackns__playResponse(soap, data, "blackJackns:playResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH_blackJackns__playResponse
#define soap_PATCH_blackJackns__playResponse(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_blackJackns__playResponse(soap, data), 0) || soap_put_blackJackns__playResponse(soap, data, "blackJackns:playResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send_blackJackns__playResponse
#define soap_POST_send_blackJackns__playResponse(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_blackJackns__playResponse(soap, data), 0) || soap_put_blackJackns__playResponse(soap, data, "blackJackns:playResponse", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct blackJackns__playResponse * SOAP_FMAC4 soap_get_blackJackns__playResponse(struct soap*, struct blackJackns__playResponse *, const char*, const char*);

#ifndef soap_read_blackJackns__playResponse
#define soap_read_blackJackns__playResponse(soap, data) ( ((data) ? (soap_default_blackJackns__playResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_blackJackns__playResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET_blackJackns__playResponse
#define soap_GET_blackJackns__playResponse(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read_blackJackns__playResponse(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv_blackJackns__playResponse
#define soap_POST_recv_blackJackns__playResponse(soap, data) ( soap_read_blackJackns__playResponse(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif
