...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.130 2023-11-22 22:53:17 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "blackJackns:play"))
		return soap_serve_blackJackns__play(soap);
...
{	struct blackJackns__getStatus soap_tmp_blackJackns__getStatus;
	...
	soap_tmp_blackJackns__getStatusResponse.block = &soap_tmp_blackJackns__tBlock;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__getStatus(soap, soap_tmp_blackJackns__getStatus.gameId, soap_tmp_blackJackns__getStatus.playerName, soap_tmp_blackJackns__getStatusResponse.block);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_blackJackns__play(struct soap *soap)
{	struct blackJackns__play soap_tmp_blackJackns__play;
	struct blackJackns__playResponse soap_tmp_blackJackns__playResponse;
	int soap_tmp_int;
	soap_default_blackJackns__playResponse(soap, &soap_tmp_blackJackns__playResponse);
	soap_default_int(soap, &soap_tmp_int);
	soap_tmp_blackJackns__playResponse.code = &soap_tmp_int;
	soap_default_blackJackns__play(soap, &soap_tmp_blackJackns__play);
	if (!soap_get_blackJackns__play(soap, &soap_tmp_blackJackns__play, "blackJackns:play", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__play(soap, soap_tmp_blackJackns__play.playerName, soap_tmp_blackJackns__play.gameId, soap_tmp_blackJackns__play.playerMove, soap_tmp_blackJackns__playResponse.code);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
	soap_serialize_blackJackns__playResponse(soap, &soap_tmp_blackJackns__playResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_blackJackns__playResponse(soap, &soap_tmp_blackJackns__playResponse, "blackJackns:playResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
