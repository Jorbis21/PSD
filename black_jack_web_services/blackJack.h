...
int blackJackns__getStatus (int gameId, blackJackns__tMessage playerName, blackJackns__tBlock* block);
int blackJackns__play (blackJackns__tMessage playerName, int gameId, unsigned int playerMove, blackJackns__tBlock *block);